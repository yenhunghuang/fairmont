...
from .api.routes import health, upload, parse, export, task, merge, process
...
app.include_router(merge.router)    # 跨表合併 API
app.include_router(process.router)  # 單一整合 API
