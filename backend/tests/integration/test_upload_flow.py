...
class TestUploadParseExportFlow:
    ...
    def test_complete_flow_single_document(self, client: TestClient, sample_pdf_file: Path):
        ...
        parse_response = client.post(f"/api/parse/{document_id}")
        ...
        export_response = client.post(f"/api/export/{quotation_id}/excel")
        ...
        export_status_response = client.get(f"/api/task/{export_task_id}")
    ...
    def test_document_listing_after_upload(self, client: TestClient, sample_pdf_file: Path):
        ...
        assert "documents" in data or ("data" in data and isinstance(data["data"], list))
    ...
    def test_get_quotation_details(self, client: TestClient, sample_pdf_file: Path):
        ...
        detail_response = client.get(f"/api/quotation/{quotation_id}")
